...
import com.training.kelineyt.activity.viewmodel.UserAccountViewModel
import com.training.kelineyt.databinding.FragmentUserAccountBinding
...
class UserAccountFragment : Fragment() {
    ...
    private fun showUserInformation(data: User) {
        binding.apply {
            ...
            edFirstName.setText(data.fristName)
